        ...
        <div onClick={() => {handleProgress(ticket)}} className=' bg-[#FFFFFF] shadow p-3 space-y-3'>
            <div className='flex justify-between items-center'>
                ...
                <div className={`${ticket.status==="In- Progress" ? "bg-[#F8F3B9]" : "bg-[#B9F8CF]"} py-1 px-3 bg-[#B9F8CF] rounded-2xl flex justify-center items-center gap-2`}>
                    <p className={`${ticket.status==="In- Progress" ? "bg-[#FEBB0C]": "bg-[#02A53B]"} w-4 h-4 rounded-full text-[12px] lg:text-[14px]`}></p>
                    <p> {ticket.status}</p>
                </div>
            </div>
            ...
            <div className='flex justify-between items-center'>
                <div className='text-[14px] flex justify-center items-center gap-3'>
                    ...
                    <p className={`${ticket.priority==="HIGH PRIORITY" && "text-[#F83044]"} ${ticket.priority==="MEDIUM PRIORITY" && "text-[#FEBB0C]"} ${ticket.priority==="LOW PRIORITY" && "text-[#02A53B]"} text-[12px] lg:text-[14px]`}>{ticket.priority}</p>
                </div>

                <div className='text-[12px] lg:text-[14px] text-[#627382] flex gap-3'>
                    <p>{ticket.customer}</p>
